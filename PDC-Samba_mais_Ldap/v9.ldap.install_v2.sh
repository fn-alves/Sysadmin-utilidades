...
if [ ! -f /etc/apt/sources.list.ori ];then	
    echo ""
    echo "Lista atual de repositorios salva em /etc/apt/sources.list.ori"
...
echo "deb-src http://ftp.br.debian.org/debian lenny main contrib non-free" >> /etc/apt/sources.list		       
...
chmod 777 /mnt/configurador/Registro_W7.reg
