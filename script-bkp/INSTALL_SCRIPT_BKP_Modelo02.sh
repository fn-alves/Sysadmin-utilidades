...
# e-mail: maicon@itsouza.com
 ...
 # criar os txt de configuracoes
   ...
   echo "//192.168.1.109/d$/DOCs" >> ./$raiz/config/origem_arquivos.txt
   echo "//192.168.1.150/e$/Fotos" >> ./$raiz/config/origem_arquivos.txt
...
- Informe a origem dos arquivos, quantos diretórios for necessário (uma linha para cada): //192.168.8.100/d$/Meus Docs.
...
*** Esse script é destinado para diretórios pequenos e de diversos locais, pois o mesmo criará um '.tar' para cada diretório informado no arquivo de origem.
